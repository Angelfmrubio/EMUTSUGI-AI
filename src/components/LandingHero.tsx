...
export function LandingHero() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      {/* Importamos la fuente Cinzel solo para este componente visualmente */}
      <style>
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen max-w-5xl mx-auto px-4 py-20">
        <div className="text-center text-white">
          ...
          <p className="text-lg sm:text-xl mb-12 max-w-3xl mx-auto text-white/80 drop-shadow-md leading-relaxed">
            Ven y descubre cómo <span className="text-gold-300 font-semibold glow-sm">autocrear en mí</span> genera el poder de <span className="text-gold-300 font-semibold glow-sm">creer en ti</span>:
          </p>
