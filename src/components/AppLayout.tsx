      ...
      <div className="min-h-screen flex flex-col bg-neutral-50">
        <header className="bg-white border-b border-neutral-200 py-4">
          <div className="container mx-auto px-4 flex justify-between items-center">
            <Link to="/" className="text-3xl font-bold px-4 py-2 rounded-lg bg-gradient-to-r from-gold-500/20 to-gold-600/30 text-primary hover:from-gold-500/30 hover:to-gold-600/40 transition-all">
              EMUTSUGI
            </Link>
            ...
            <div className="md:hidden flex items-center gap-2">
              <LanguageSelector currentLanguage={language} onLanguageChange={setLanguage} />
              <Button variant="ghost" size="sm" className="text-neutral-700"><MenuIcon /></Button>
            </div>
          </div>
        </header>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between">
              <div className="mb-6 md:mb-0">
                ...
                <p className="text-sm max-w-md">Plataforma de Evaluación Multimodal con enfoque en análisis semántico profundo para intervenciones psicológicas profesionales.</p>
              </div>
              <div className="grid grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li><Link to="/about" className="hover:text-primary">Acerca de</Link></li>
                    <li><Link to="/principles" className="hover:text-primary">Principios</Link></li>
                  </ul>
                </div>
                <div>
...
function NavLink({ to, children }: NavLinkProps) {
  return <Link to={to} className="text-neutral-700 hover:text-primary transition-colors">{children}</Link>;
}
