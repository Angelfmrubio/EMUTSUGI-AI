...
            {/* Botón 1: Conexión Premium (WhatsApp) - AHORA CON ICONO para alineación */}
            <a 
              href="https://wa.me/584147475917?text=Hola,%20me%20interesa%20la%20Conexión%20Premium%20EMUTSUGI." 
              target="_blank" 
...
                size="sm" 
              >
                Conexión Premium <ExternalLink className="h-3 w-3 ml-1" />
              </Button>
            </a>
            
            {/* Botón 2: AngelStudio7 (Estructura de enlace uniforme) */}
            <a
              href="https://angelstudio7.rdi.store/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button 
